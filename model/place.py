...
class Location:
    ...
    def __init__(self,clues,intelligence,danger,hunger,name):
    ...
    def show_location_info(self,location):
        ...
        print(f'Clues : {location.clues}')
        print(f'Intelligence : {location.intelligence}')
        print(f'Fear : {location.fear}')
        print(f'Hunger : {location.hunger}')
...
'Strange static on an old radio buried near the altar'],intelligence=10,danger=75,hunger=-20,name='church')
...
'Waitress mentions: Dont trust anyone who knows too much'],intelligence=10,hunger=80,name='diner',danger=50)
...
'Blueprint of town layout with missing exit route'],intelligence=5,hunger=-40,name='colony house',danger=80)
...
'Hidden floorboards revealing buried metal hatch'],intelligence=5,hunger=-20,name='barn',danger=90)
...
'Medical chart showing unexplained repeated injuries at night'],intelligence=10,hunger=-20,name='hospital',danger= 10)
...
'A compass that always points toward the same hidden direction'],intelligence=5,hunger=-20,name='forest',danger=100)
